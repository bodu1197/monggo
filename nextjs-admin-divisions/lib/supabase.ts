...
logger.log('Supabase URL from env:', process.env.NEXT_PUBLIC_SUPABASE_URL);
logger.log('Supabase Anon Key from env:', process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ? 'Loaded' : 'NOT LOADED');
