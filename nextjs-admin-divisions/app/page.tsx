...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-gray-100"> {/* Removed justify-center to allow content to flow */}
      <div className="w-full max-w-7xl bg-gray-100 p-6 rounded-lg shadow-xl">
