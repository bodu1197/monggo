  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-gray-800 text-white shadow-lg z-50">
      <div className="flex justify-around items-center h-16">
        {navItems.map((item) => (
          <Link key={item.name} href={item.path} className={`flex flex-col items-center justify-center text-xs ${pathname === item.path ? 'text-indigo-400' : 'text-gray-400'} hover:text-white`}>
            {item.icon}
